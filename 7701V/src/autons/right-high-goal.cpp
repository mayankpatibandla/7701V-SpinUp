...
void autons::rightHighGoal() {
  ...
  flyMtrs.spin(fwd, 0.8 * 12, volt);
  turnToAngle(2.75, 250, 1750, 0.5, {0.8, 0, 0.1});
  ...
  // shoot discs
  turnToAngle(-2.1, 300, 1500, 0.75, {0.6, 0, 0.0075}); //-2.325
